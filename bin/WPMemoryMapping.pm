...
# Overview
    ...
    'OutdoorTemp'           			=> { function => 3, addr => 0x01B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor', format => "%.2f", unit => '캜'},
    'OutdoorTemp1h'         			=> { function => 4, addr => 0x01D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor 1h', format => "%.2f", unit => '캜'},
    'OutdoorTemp24h'        			=> { function => 4, addr => 0x01F1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor 24h', format => "%.2f", unit => '캜'},
    'HeatSourceIn'          			=> { function => 3, addr => 0x0211, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source in', format => "%.2f", unit => '캜'},
    'HeatSourceOut'         			=> { function => 3, addr => 0x0231, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source out', format => "%.2f", unit => '캜'},
    'EvaporationTemp'       			=> { function => 3, addr => 0x0251, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T evaporator', format => "%.2f", unit => '캜'},
    'SunctionGasTemp'       			=> { function => 3, addr => 0x0271, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T sunction line', format => "%.2f", unit => '캜'},
    'EvaporationPress'      			=> { function => 3, addr => 0x0291, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'p evaporator', format => "%.2f", unit => 'bar'},
    'ReturnTempNominal'     			=> { function => 4, addr => 0x02B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', format => "%.2f", unit => '캜'},
    'ReturnTemp'            			=> { function => 3, addr => 0x02D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', format => "%.2f", unit => '캜'},
    'FlowTemp'              			=> { function => 3, addr => 0x02F1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T heating out', format => "%.2f", unit => '캜'},
    'CondensationTemp'     			    => { function => 3, addr => 0x0311, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T condenser', format => "%.2f", unit => '캜'},
    'CondensationPress'     			=> { function => 3, addr => 0x0331, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'p condenser', format => "%.2f", unit => 'bar'},
    'RoomTemp'              			=> { function => 3, addr => 0x0351, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room', format => "%.2f", unit => '캜'},
    'RoomTemp1h'            			=> { function => 4, addr => 0x0371, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room 1h', format => "%.2f", unit => '캜'},
    'DomesticWaterTemp'     			=> { function => 4, addr => 0x0391, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T hot water', format => "%.2f", unit => '캜'},
    'PoolTemp'              			=> { function => 4, addr => 0x03B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pool', format => "%.2f", unit => '캜'},
    'SolarTemp'             			=> { function => 3, addr => 0x03D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T solar', format => "%.2f", unit => '캜'},
# Heating
    ...
    'HeatCharacteristicSetPoint'		=> { function => 4, addr => 0x0421, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T out begin', format => "%.2f", unit => '캜'},
    'HeatCharacteristicSetPointBaseTemp'=> { function => 4, addr => 0x0441, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return base', format => "%.2f", unit => '캜'},
    'HeatCharacteristicGradient'        => { function => 4, addr => 0x0461, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve gradient', unit => '%'},
    'HeatCharacteristicLimit'           => { function => 4, addr => 0x0481, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve limit', format => "%.2f", unit => '캜'},
    'HeatReturnTemp'                    => { function => 4, addr => 0x04A1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', format => "%.2f", unit => '캜'},
    'HeatReturnTempNominal'             => { function => 4, addr => 0x04C1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', format => "%.2f", unit => '캜'},
    'HeatTempHyst'                      => { function => 4, addr => 0x04E1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Hysteresis', unit => 'K'},
    'RoomTempNominal'                   => { function => 4, addr => 0x0501, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room target', format => "%.2f", unit => '캜'},
...
# PowerColculation
    'Pelectric'                         => { function => 4, addr => 0x1191, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'P electric', format => "%.2f", unit => 'kW'},
    'Pthermal'                          => { function => 4, addr => 0x11B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'P thermal', format => "%.2f", unit => 'kW'},
    'COP'                               => { function => 4, addr => 0x11D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'COP', format => "%.2f", unit => ''},
