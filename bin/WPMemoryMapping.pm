...
# Overview
    ...
    'OutdoorTemp'           			=> { function => 3, addr => 0x01B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor', webcaption => "T<sub>A</sub>", format => "%.2f", unit => '캜'},
    'OutdoorTemp1h'         			=> { function => 4, addr => 0x01D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor 1h', webcaption => "T<sub>A1h</sub>", format => "%.2f", unit => '캜'},
    'OutdoorTemp24h'        			=> { function => 4, addr => 0x01F1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor 24h', webcaption => "T<sub>A24h</sub>", format => "%.2f", unit => '캜'},
    'HeatSourceIn'          			=> { function => 3, addr => 0x0211, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source in', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatSourceOut'         			=> { function => 3, addr => 0x0231, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source out', webcaption => "", format => "%.2f", unit => '캜'},
    'EvaporationTemp'       			=> { function => 3, addr => 0x0251, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T evaporator', webcaption => "", format => "%.2f", unit => '캜'},
    'SunctionGasTemp'       			=> { function => 3, addr => 0x0271, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T sunction line', webcaption => "", format => "%.2f", unit => '캜'},
    'EvaporationPress'      			=> { function => 3, addr => 0x0291, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'p evaporator', webcaption => "", format => "%.2f", unit => 'bar'},
    'ReturnTempNominal'     			=> { function => 4, addr => 0x02B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', webcaption => "", format => "%.2f", unit => '캜'},
    'ReturnTemp'            			=> { function => 3, addr => 0x02D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', webcaption => "", format => "%.2f", unit => '캜'},
    'FlowTemp'              			=> { function => 3, addr => 0x02F1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T heating out', webcaption => "", format => "%.2f", unit => '캜'},
    'CondensationTemp'     			    => { function => 3, addr => 0x0311, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T condenser', webcaption => "", format => "%.2f", unit => '캜'},
    'CondensationPress'     			=> { function => 3, addr => 0x0331, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'p condenser', webcaption => "", format => "%.2f", unit => 'bar'},
    'RoomTemp'              			=> { function => 3, addr => 0x0351, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room', webcaption => "T<sub>Raum</sub>", format => "%.2f", unit => '캜'},
    'RoomTemp1h'            			=> { function => 4, addr => 0x0371, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room 1h', webcaption => "T<sub>Raum 1h</sub>", format => "%.2f", unit => '캜'},
    'DomesticWaterTemp'     			=> { function => 4, addr => 0x0391, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T hot water', webcaption => "", format => "%.2f", unit => '캜'},
    'PoolTemp'              			=> { function => 4, addr => 0x03B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pool', webcaption => "", format => "%.2f", unit => '캜'},
    'SolarTemp'             			=> { function => 3, addr => 0x03D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T solar', webcaption => "", format => "%.2f", unit => '캜'},
# Heating
    ...
    'HeatCharacteristicSetPoint'		=> { function => 4, addr => 0x0421, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T out begin', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatCharacteristicSetPointBaseTemp'=> { function => 4, addr => 0x0441, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return base', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatCharacteristicGradient'        => { function => 4, addr => 0x0461, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve gradient', webcaption => "", unit => '%'},
    'HeatCharacteristicLimit'           => { function => 4, addr => 0x0481, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve limit', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatReturnTemp'                    => { function => 4, addr => 0x04A1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatReturnTempNominal'             => { function => 4, addr => 0x04C1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', webcaption => "", format => "%.2f", unit => '캜'},
    'HeatTempHyst'                      => { function => 4, addr => 0x04E1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Hysteresis', webcaption => "", unit => 'K'},
    'RoomTempNominal'                   => { function => 4, addr => 0x0501, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pilot room target', webcaption => "T<sub>Raum-Soll</sub>", format => "%.2f", unit => '캜'},
...
# Cooling
    ...
    'CoolCharacteristicSetPoint'        => { function => 4, addr => 0x05E1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T out base', format => "%.2f", unit => '캜'},
    'CoolReturnTemp'                    => { function => 4, addr => 0x0601, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', format => "%.2f", unit => '캜'},
    'CoolReturnTempNominal'             => { function => 4, addr => 0x0621, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', format => "%.2f", unit => '캜'},
...
# Hot Water
    ...
    'DomesticWaterTempActual'           => { function => 4, addr => 0x0691, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T water real', format => "%.2f", unit => '캜'},
    'DomesticWaterTempNominal'          => { function => 4, addr => 0x06B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T water target', format => "%.2f", unit => '캜'},
    ...
    'LegionellaTempNominal'             => { function => 4, addr => 0x0721, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Legio. Nominal', format => "%.2f", unit => '캜'},
...
# Pool
    ...
    'PoolTempActual'                    => { function => 4, addr => 0x0791, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', format => "%.2f", unit => '캜'},
    'PoolTempNominal'                   => { function => 4, addr => 0x07B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return target', format => "%.2f", unit => '캜'},
...
# Solar
    ...
    'SolarTempActual'                   => { function => 3, addr => 0x0851, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T solar', format => "%.2f", unit => '캜'},
    'SolarTempReturn'                   => { function => 4, addr => 0x0871, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return solar', format => "%.2f", unit => '캜'},
    'SolarTempNominalMin'               => { function => 4, addr => 0x0891, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return min', format => "%.2f", unit => '캜'},
    'SolarTempHyst'                     => { function => 4, addr => 0x08B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Hysteresis', unit => 'K'},
# MixerValve
    'HeatingCircuitTemp'                => { function => 4, addr => 0x08D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T circuit', format => "%.2f", unit => '캜'},
    ...
    'CharacteristicSetPointBaseTemp'    => { function => 3, addr => 0x0911, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T out base', format => "%.2f", unit => '캜'},
    'CharacteristicGradient'            => { function => 4, addr => 0x0931, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve gradient', unit => '%'},
    'CharacteristicLimit'               => { function => 4, addr => 0x0951, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T curve limit', format => "%.2f", unit => '캜'},
    'HeatingCircuitNominal'             => { function => 4, addr => 0x0971, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T nominal', format => "%.2f", unit => '캜'},
...
# AuxiliaryHeat
    ...
    'AuxiliaryHeatTempLimitSourceIn'    => { function => 4, addr => 0x0A21, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'LimitHeatSrcIn', unit => '째C'},
# OperatingHours
...
# Failure
    ...
    'FailureTempReturn'                 => { function => 4, addr => 0x0DB1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T return real', format => "%.2f", unit => '캜'},
    'FailureTempFlow'                   => { function => 4, addr => 0x0DD1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T heating out', format => "%.2f", unit => '캜'},
    'FailureTempHeatSourceIn'           => { function => 4, addr => 0x0DF1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source in', format => "%.2f", unit => '캜'},
    'FailureTempHeatSourceOut'          => { function => 4, addr => 0x0E11, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T source out', format => "%.2f", unit => '캜'},
    'FailureTempSuctionGas'             => { function => 4, addr => 0x0E31, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T suction line', format => "%.2f", unit => '캜'},
    'FailureTempOutdoor'                => { function => 4, addr => 0x0E51, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T outdoor', format => "%.2f", unit => '캜'},
    'FailureTempDomesticWater'          => { function => 4, addr => 0x0E71, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T hot water', format => "%.2f", unit => '캜'},
    'FailureTempPool'                   => { function => 4, addr => 0x0E91, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T pool', format => "%.2f", unit => '캜'},
    'FailureTempSolar'                  => { function => 4, addr => 0x0EB1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'T solar', format => "%.2f", unit => '캜'},
# Service
    ...
    'ScreedTempNominal'                 => { function => 4, addr => 0x0F41, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'First heating temp', format => "%.2f", unit => '캜'},
...
# Default
    ...
    'HeatSourceMinT'                    => { function => 4, addr => 0x1101, size => 0x1, acl => '', type => TYPE_BYTE, caption => 'Heat source Tmin (+2 째C: -1 째C:-9 째C)', unit => ''},
