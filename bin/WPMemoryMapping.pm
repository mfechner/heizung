...
# Heating
    ...
    'HeatTempHyst'                      => { function => 4, addr => 0x04E1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Heating Hysteresis', webcaption => "", unit => 'K'},
...
# Cooling
    ...
    'CoolReturnTempHyst'                => { function => 4, addr => 0x0641, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Cooling Hysteresis', format => "%.2f", unit => '&deg;K'},
# Hot Water
    ...
    'DomesticWaterTempHyst'             => { function => 4, addr => 0x06D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Domestic Water Hysteresis', format => "%.2f", unit => '&deg;K'},
...
# Pool
    ...
    'PoolTempHyst'                      => { function => 4, addr => 0x07D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Pool Hysteresis', unit => 'K'},
...
# Solar
    ...
    'SolarTempHyst'                     => { function => 4, addr => 0x08B1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Solar Hysteresis', unit => 'K'},
# MixerValve
    ...
    'Hysteresis'                        => { function => 4, addr => 0x09D1, size => 0x2, acl => '', type => TYPE_FLOAT, caption => 'Mixer Hysteresis', unit => '%'},
